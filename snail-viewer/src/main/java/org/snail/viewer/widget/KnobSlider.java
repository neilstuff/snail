...
class KnobSlider extends JComponent implements MouseListener, MouseMotionListener {
	 ...
	 */
	public KnobSlider(double initTheta) {
	 ...
	 */
	public KnobSlider(double initTheta, Color initKnobColor, Color initSpotColor) {
	...
	public void paint(Graphics g) {
		...
		// Draw the knob.
		g2.setColor(knobColor.brighter());
		...
		g2.fillOval(xc - spotRadius, yc - spotRadius, 2 * spotRadius, 2 * spotRadius);
